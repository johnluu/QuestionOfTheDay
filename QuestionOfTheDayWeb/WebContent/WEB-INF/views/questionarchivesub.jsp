...
<body>
<div class = inner style= "border-color:red;">
...
HashMap<Integer,Integer> userChoices = null; 
	...
	for(Question q: QuestionList)
	{
		...
		out.print("<a class = 'archive' name='question" + q.getQuestion_id() + "'" +  "href ='Questions?&questionid=" + q.getQuestion_id()+ "'>" + q.getQuestion_text() + "</a><br/>");
